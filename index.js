        ...
        switch (true) {
            case ans.operations == `Cash Withdraw`:
                inquirer
                    ...
                    .then((ans) => {
                    console.log(chalk.redBright(`Successfully Withdrew Rs${ans.withdraw} Amount Of Money`));
                    console.log(chalk.greenBright(`After Withdraw BALANCE: ${x.money - ans.withdraw}`));
                });
                break;
            case ans.operations == `Deposit`:
                inquirer
                    ...
                    .then((ans) => {
                    console.log(chalk.redBright(`Successfully Deposited Rs${ans.deposit} Amount Of Money`));
                    console.log(chalk.greenBright(`After Deposit BALANCE: ${x.money + ans.deposit}`));
                });
                break;
            case ans.operations == `Fund Transfer`:
                {
                    inquirer
                        ...
                        .then((ans) => {
                        console.log(chalk.redBright(`Successfully Transferred Rs${ans.transfer} Amount Of Money to Sylani Welfare Trust`));
                        console.log(chalk.greenBright(`After Transfer BALANCE: ${x.money - ans.transfer}`));
                    });
                }
                break;
                    ...
                    inquirer
                        ...
                        switch (true) {
                            case ans.bills == `Electricity`:
                                console.log(chalk.redBright(`Rs ${bills[0]} has been paid in ${ans.bills} bill`));
                                console.log(chalk.greenBright(`After Bill Payment BALANCE: ${x.money - bills[0]}`));
                                break;
                            case ans.bills == `Gas`:
                                console.log(chalk.redBright(`Rs ${bills[1]} has been paid in ${ans.bills} bill`));
                                console.log(chalk.greenBright(`After Bill Payment BALANCE: ${x.money - bills[1]}`));
                                break;
                            case ans.bills == `Utility`:
                                console.log(chalk.redBright(`Rs ${bills[2]} has been paid in ${ans.bills} bill`));
                                console.log(chalk.greenBright(`After Bill Payment BALANCE: ${x.money - bills[2]}`));
                                break;
                        }
                    });
                }
